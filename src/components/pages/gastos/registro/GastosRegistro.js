          ...
          <div style={{width: '55%'}}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)' }}>
              ...
              <FormControl variant="standard" sx={{ ml: 2, my: 3, minWidth: 120 }}>
                ...
                <Select labelId="categoria_gasto-label" className="browser-default" defaultValue={999} id="categoria_gasto" name="categoria_gasto">
                  <MenuItem value="999" disabled selected>-- SELECCIONE --</MenuItem>
                  {categoria_gastos}
                </Select>
              </FormControl>
              <FormControl variant="standard" sx={{ mr: 1, my: 2, minWidth: 120 }}>
              ...
              <FormControl variant="standard" sx={{ ml: 1, my: 2, minWidth: 120 }}>
